...
{
	readonly List<TextBox> textureTypeList = [];
	readonly List<TextBox> texturePathList = [];
	...
	public MaterialEdit(FLVER2 _flver, int _materialIndex)
	{
		...
		for (int i = 0; i < material.Textures.Count; i++)
		{
			...
			groupBoxTextures.Controls.Add(new TextBox { Size = new Size(585, 15), Location = new Point(50, y - 3), Text = material.Textures[i].Type });
