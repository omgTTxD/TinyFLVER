namespace TinyFLVER
{
	partial class MaterialEdit
	{
		...
		private void InitializeComponent()
		{
			...
			// textBoxMaterialPath
			// 
			textBoxMaterialPath.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
			...
			textBoxMaterialPath.Size = new Size(492, 23);
			textBoxMaterialPath.TabIndex = 3;
			// 
			// buttonOK
			// 
			buttonOK.Location = new Point(574, 14);
			...
			// buttonCancel
			// 
			buttonCancel.Location = new Point(574, 47);
			...
			// buttonSaveJson
			// 
			buttonSaveJson.Location = new Point(574, 80);
			...
			groupBoxMaterial.Size = new Size(552, 92);
			...
			// groupBoxTextures
			// 
			groupBoxTextures.AutoSize = true;
			groupBoxTextures.Location = new Point(13, 294);
			...
			groupBoxTextures.Size = new Size(653, 56);
			...
			textBoxJson.Location = new Point(4, 19);
			...
			textBoxJson.Size = new Size(646, 153);
