...
public class Flver
{
	...
	{
		form.buttonImportFBX.Click += (s, e) => { if (FbxImport.importFBX(form)) ProcessNewFlver(); };
		form.buttonSave.Click += buttonSave_Click;
		form.buttonLoad.Click += (s, e) => { path = null;  OpenFlver(); };

		//path = "A:\\TinyFLVER\\bd_m_5070\\BD_M_5070.flver";
		//path = "D:\\Models\\Gwynevere\\Orig\\c5310.flver";
