public class Flver
{
	...
	public static void Initialize()
	{
		...
		if (path is null)
			//	path = "R:\\FLVER Models\\2B\\BD_M_5070.flver";
			//	path = "R:\\Nightreign\\Wylder 2B\\parts\\bd_m_5000\\BD_M_5000.flver";
			//	path = "R:\\FLVER Models\\Gwynevere\\Orig\\c5310.flver"; 
	...
	public static void OpenFlver()
	{
		...
		watcher = new FileSystemWatcher(Path.GetDirectoryName(path)) { NotifyFilter = NotifyFilters.LastWrite, EnableRaisingEvents = true };
		watcher.Changed += (s, e) => Texture.Reload();
	...
	{
		var selectedMeshes = Meshes.Where(m => m.Selected).ToList();
