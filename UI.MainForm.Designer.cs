partial class MainForm
{
	...
	private void InitializeComponent()
	{
			...
			this.usingSRGB = new System.Windows.Forms.DataGridViewCheckBoxColumn();
			this.debugNormals = new System.Windows.Forms.CheckBox();
			this.timer = new System.Windows.Forms.Timer(this.components);
			this.formatSRGBDataGridViewCheckBoxColumn = new System.Windows.Forms.DataGridViewCheckBoxColumn();
			...
			this.shadersList.FlatStyle = System.Windows.Forms.FlatStyle.System;
			...
			this.shadersList.Location = new System.Drawing.Point(844, 47);
			this.shadersList.Name = "shadersList";
			this.shadersList.Size = new System.Drawing.Size(110, 21);
			...
			this.flverVersions.Location = new System.Drawing.Point(844, 22);
			this.flverVersions.Name = "flverVersions";
			this.flverVersions.Size = new System.Drawing.Size(110, 21);
			...
			this.buttonSave.Location = new System.Drawing.Point(414, 65);
			...
			this.buttonImportFBX.Location = new System.Drawing.Point(414, 39);
			...
			// buttonLoad
			// 
			this.buttonLoad.Location = new System.Drawing.Point(414, 10);
			...
			this.dataGridMeshes.Size = new System.Drawing.Size(376, 31);
            ...
            this.formatSRGBDataGridViewCheckBoxColumn,
            this.usingSRGB,
			...
			this.dataGridTextures.Location = new System.Drawing.Point(10, 59);
			this.dataGridTextures.Name = "dataGridTextures";
			this.dataGridTextures.RowHeadersVisible = false;
			this.dataGridTextures.ScrollBars = System.Windows.Forms.ScrollBars.Horizontal;
			this.dataGridTextures.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.dataGridTextures.Size = new System.Drawing.Size(376, 26);
			this.dataGridTextures.TabIndex = 51;
			// 
			// usingSRGB
			// 
			this.usingSRGB.DataPropertyName = "usingSRGB";
			this.usingSRGB.HeaderText = "Using sRGB";
			this.usingSRGB.Name = "usingSRGB";
			this.usingSRGB.Width = 40;
			// 
			// debugNormals
			// 
			this.debugNormals.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.debugNormals.AutoSize = true;
			this.debugNormals.Location = new System.Drawing.Point(855, 79);
			this.debugNormals.Name = "debugNormals";
			this.debugNormals.Size = new System.Drawing.Size(99, 17);
			this.debugNormals.TabIndex = 52;
			this.debugNormals.Text = "Debug Normals";
			this.debugNormals.UseVisualStyleBackColor = true;
			this.debugNormals.Visible = false;
			// 
			// timer
			// 
			...
			// 
			// formatSRGBDataGridViewCheckBoxColumn
			// 
			this.formatSRGBDataGridViewCheckBoxColumn.DataPropertyName = "formatSRGB";
			this.formatSRGBDataGridViewCheckBoxColumn.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.formatSRGBDataGridViewCheckBoxColumn.HeaderText = "Format sRGB";
			this.formatSRGBDataGridViewCheckBoxColumn.Name = "formatSRGBDataGridViewCheckBoxColumn";
			this.formatSRGBDataGridViewCheckBoxColumn.ReadOnly = true;
			this.formatSRGBDataGridViewCheckBoxColumn.Width = 50;
			// 
			...
			this.texturePathDataGridViewTextBoxColumn.HeaderText = "Path";
			this.texturePathDataGridViewTextBoxColumn.Name = "texturePathDataGridViewTextBoxColumn";
			this.texturePathDataGridViewTextBoxColumn.Width = 52;
			// 
			// textureTypeDataGridViewTextBoxColumn
			// 
			this.textureTypeDataGridViewTextBoxColumn.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
			this.textureTypeDataGridViewTextBoxColumn.DataPropertyName = "TextureType";
			this.textureTypeDataGridViewTextBoxColumn.HeaderText = "Type";
			...
			this.materialIndexDataGridViewTextBoxColumn.HeaderText = "Material Index";
			this.materialIndexDataGridViewTextBoxColumn.Name = "materialIndexDataGridViewTextBoxColumn";
			this.materialIndexDataGridViewTextBoxColumn.Width = 40;
			// 
			// columnMaterialName
			// 
			...
			this.dataGridViewCheckBoxColumn1.HeaderText = "Hidden";
			...
			this.Controls.Add(this.debugNormals);
	...
	private DataGridViewCheckBoxColumn formatSRGBDataGridViewCheckBoxColumn;
	private DataGridViewCheckBoxColumn usingSRGB;
