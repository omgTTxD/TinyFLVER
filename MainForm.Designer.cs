partial class MainForm
{
	...
	private void InitializeComponent()
	{
		...
		checkBoxFlipY = new CheckBox();
		checkBoxSwapXY = new CheckBox();
		checkBoxFlipX = new CheckBox();
		label1 = new Label();
		label2 = new Label();
		label4 = new Label();
		...
		comboBoxShaders.Location = new Point(994, 39);
		...
		LightAtCamera.Location = new Point(979, 128);
		...
		// GuessTexture
		// 
		GuessTexture.Anchor = AnchorStyles.Top | AnchorStyles.Right;
		GuessTexture.AutoSize = true;
		GuessTexture.Location = new Point(983, 153);
		...
		comboBoxDebugID.Items.AddRange(new object[] { "Result", "Specular", "SpecularIBL", "SpecularFull", "Diffuse", "DiffuseIBL", "DiffuseFull", "D", "G", "F", "F.IBL" });
		comboBoxDebugID.Location = new Point(994, 68);
		...
		// checkBoxFlipY
		// 
		checkBoxFlipY.Anchor = AnchorStyles.Top | AnchorStyles.Right;
		checkBoxFlipY.AutoSize = true;
		checkBoxFlipY.Location = new Point(1062, 253);
		checkBoxFlipY.Name = "checkBoxFlipY";
		checkBoxFlipY.Size = new Size(55, 19);
		checkBoxFlipY.TabIndex = 63;
		checkBoxFlipY.Text = "Flip Y";
		checkBoxFlipY.UseVisualStyleBackColor = true;
		// 
		// checkBoxSwapXY
		// 
		checkBoxSwapXY.Anchor = AnchorStyles.Top | AnchorStyles.Right;
		checkBoxSwapXY.AutoSize = true;
		checkBoxSwapXY.Location = new Point(987, 278);
		checkBoxSwapXY.Name = "checkBoxSwapXY";
		checkBoxSwapXY.Size = new Size(131, 19);
		checkBoxSwapXY.TabIndex = 64;
		checkBoxSwapXY.Text = "Swap XY (after flips)";
		checkBoxSwapXY.UseVisualStyleBackColor = true;
		// 
		// checkBoxFlipX
		// 
		checkBoxFlipX.Anchor = AnchorStyles.Top | AnchorStyles.Right;
		checkBoxFlipX.AutoSize = true;
		checkBoxFlipX.Location = new Point(1001, 253);
		checkBoxFlipX.Name = "checkBoxFlipX";
		checkBoxFlipX.Size = new Size(55, 19);
		checkBoxFlipX.TabIndex = 65;
		checkBoxFlipX.Text = "Flip X";
		checkBoxFlipX.UseVisualStyleBackColor = true;
		// 
		// label1
		// 
		label1.Anchor = AnchorStyles.Top | AnchorStyles.Right;
		label1.AutoSize = true;
		label1.Location = new Point(969, 221);
		label1.Name = "label1";
		label1.Size = new Size(147, 15);
		label1.TabIndex = 66;
		label1.Text = "Preview normal map edits:";
		// 
		// MainForm
		// 
		...
		Controls.Add(label1);
		Controls.Add(checkBoxFlipX);
		Controls.Add(checkBoxSwapXY);
		Controls.Add(checkBoxFlipY);
	...
	private Button buttonCopyMaterial;
	private Button buttonPasteMaterial;
	...
	public CheckBox checkBoxFlipY;
	public CheckBox checkBoxSwapXY;
	public CheckBox checkBoxFlipX;
