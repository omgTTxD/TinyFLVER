...
class Desc
{
	public static string[] debugPBR =   { "Result", "Roughness", "Metalness", "Fresnel", "FresnelIBL", "Distribution", "Geometry","Cubemap", "Irradiance", "SpecularColor", "Specular", "SpecularIBL",  "SpecularFull","DiffuseColor", "Diffuse", "DiffuseIBL",  "DiffuseFull", "Subsurface", "F0" };
	...
	public static string[] debugNormals = {
		...
		"B.x.Flver", "B.x.Recalc", "B.y.Flver", "B.y.Recalc", "B.z.Flver", "B.z.Recalc",
			"finalN.x.Flver", "finalN.x.Recalc", "finalN.y.Flver", "finalN.y.Recalc", "finalN.z.Flver", "finalN.z.Recalc", 
		"T.w.Flver", "T.w.Recalc", "uv.x", "uv.y",
		"N.x", "N.y", "N.z", "TextureN.x", "TextureN.y", "TextureN.z"
	};



	public static FLVER2.BufferLayout BufferLayoutDSR => new() {
			new (Type.Float3, Semantic.Position),
			new (Type.UByte4Norm, Semantic.Normal),
			new (Type.UByte4Norm, Semantic.Tangent),
			new (Type.Short2, Semantic.UV),
			new (Type.UByte4Norm, Semantic.VertexColor, 1),
			new (Type.UByte4, Semantic.BoneIndices),
			new (Type.Short4Norm, Semantic.BoneWeights),
	};



	public static FLVER2.BufferLayout BufferLayoutER => new () {
			new (Type.Float3, Semantic.Position),
	...
	public static FLVER2.Material Metallic(SharpAssimp.Material m) {
	...
	public static FLVER2.Material Skin(SharpAssimp.Material m) => new (m.Name, "C[DetailBlend]_SSS.matxml", 0) 
	{
		Index = flver.Materials.Count,
		Textures = {
