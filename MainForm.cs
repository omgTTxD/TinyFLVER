...
public partial class MainForm : Form
{
	...
	public MainForm()
	{
		...
		Location = new Point(Screen.PrimaryScreen.Bounds.Width / 5, Screen.PrimaryScreen.Bounds.Width / 40);
		Size = new Size(Screen.PrimaryScreen.Bounds.Width / 2, Screen.PrimaryScreen.Bounds.Height / 8 * 7);
	...
	private void MainForm_KeyDown(object sender, KeyEventArgs e)
	{
		...
		if (e.KeyCode == Keys.Space && monoGame.GetSelectedMeshes().Length == 1) {
			new MaterialEdit(flver, monoGame.GetSelectedMeshes()[0].flverMesh.MaterialIndex).ShowDialog();
