...
public partial class FbxImport : Form
{
	...
	public static bool importFBX(MainForm mainForm)
	{
		var flver = Flver.flver;
		...
		int layoutCount = Flver.flver.BufferLayouts.Count;
		FLVER2.BufferLayout newBL = new FLVER2.BufferLayout
		{
			new SoulsFormats.FLVER.LayoutMember(SoulsFormats.FLVER.LayoutType.Float3, SoulsFormats.FLVER.LayoutSemantic.Position, 0),
	...
	static SoulsFormats.FLVER.Vertex generateVertex(Vector3 pos, Vector3 uv1, Vector3 uv2, Vector3 normal, Vector3 tangets, float tangentW = -1)
	{
