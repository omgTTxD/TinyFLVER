...
public partial class FbxImport : Form
{
	public class FbxImportSettings
	{
		private static string SettingsFilePath => Path.Combine(
			Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location),	"fbx_import_settings.json");
	...
	public static void importFBX(MainForm mainForm)
	{
		...
		FLVER2.BufferLayout newBL = new FLVER2.BufferLayout
		{
			...
			new SoulsFormats.FLVER.LayoutMember(SoulsFormats.FLVER.LayoutType.Float3, SoulsFormats.FLVER.LayoutSemantic.Normal, 0),
			new SoulsFormats.FLVER.LayoutMember(SoulsFormats.FLVER.LayoutType.Float4, SoulsFormats.FLVER.LayoutSemantic.Tangent, 0),
		//	new SoulsFormats.FLVER.LayoutMember(SoulsFormats.FLVER.LayoutType.Byte4A, SoulsFormats.FLVER.LayoutSemantic.BoneIndices, 0),
		//	new SoulsFormats.FLVER.LayoutMember(SoulsFormats.FLVER.LayoutType.Byte4A, SoulsFormats.FLVER.LayoutSemantic.BoneWeights, 0),
			new SoulsFormats.FLVER.LayoutMember(SoulsFormats.FLVER.LayoutType.Float2, SoulsFormats.FLVER.LayoutSemantic.UV, 0)
		};
	...
	private static float GetAxisValue(Vector3 v, FbxImportSettings.Axis axis)
	{
		switch (axis)
		{
			...
			case FbxImportSettings.Axis.NegZ: return v.Y;
			case FbxImportSettings.Axis.Y: return v.Z;
			case FbxImportSettings.Axis.NegX: return -v.X;
			case FbxImportSettings.Axis.Z: return -v.Y;
			case FbxImportSettings.Axis.NegY: return -v.Z;
