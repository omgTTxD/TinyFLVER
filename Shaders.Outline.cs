...
{
	static string path = AppContext.BaseDirectory + "Shaders\\Outline.hlsl";
	...
	{
		var oldFlag = shaderData.flag;
		shaderData.flag = m == nearestMesh && m.Selected == false ? 1 : 0;
